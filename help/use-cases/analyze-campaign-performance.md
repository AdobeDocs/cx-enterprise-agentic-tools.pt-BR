...
| Detalhes do cenário | |
| --- | --- |
| **Aplicativos da CX Enterprise** | [Customer Journey Analytics (CJA)](https://experienceleague.adobe.com/pt-br/docs/analytics-platform/using/cja-overview/cja-overview) |
